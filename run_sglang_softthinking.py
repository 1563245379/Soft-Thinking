...
def main():
    ...
    parser.add_argument('--api_base', type=str, default="https://api.deepseek.com", help='Judge API base URL. Supports OpenAI-compatible endpoints such as https://api.deepseek.com')
